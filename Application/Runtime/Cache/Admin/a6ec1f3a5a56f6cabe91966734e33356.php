		...
		<div class="n-menu">
			<ul class="n-parmenu">
				<li class="n-firstlevel">
					...
					<ul class="n-submenu">
						<li><a href="<?php echo U('Admin/school_list');?>">学校列表</a></li>
						<li><a href="<?php echo U('Admin/class_leader_info');?>">学校负责人</a></li>
					</ul>
				</li>
				<li class="n-firstlevel">
					设备管理
					...
					<span class="n-line"></span>
					<ul class="n-submenu">
						<li><a href="<?php echo U('Class/student_info');?>">添加设备</a></li>
